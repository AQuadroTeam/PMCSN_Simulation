...
data_cell_array = simN20S10batchtimetotal1000
...
response_1_2 = zeros(counter_jobs_per_batch_path(batch_to_consider,1),1);
response_2_1 = zeros(counter_jobs_per_batch_path(batch_to_consider,1),1);
response_2_2 = zeros(counter_jobs_per_batch_path(batch_to_consider,1),1);
response_2_S_2 = zeros(counter_jobs_per_batch_path(batch_to_consider,1),1);
...
if counter_jobs_per_batch_path(batch_to_consider, 5) > 0
    exp_2_S_2 = fitdist(response_2_S_2,'exponential')
end


%%
if counter_jobs_per_batch_path(batch_to_consider, 1) > 0
    [a_1_1,b_1_1,c_1_1]=chi2gof(response_1_1, 'CDF',exp_1_1)
end
if counter_jobs_per_batch_path(batch_to_consider, 2) > 0
